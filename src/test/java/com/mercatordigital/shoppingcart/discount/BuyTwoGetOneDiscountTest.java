...
public class BuyTwoGetOneDiscountTest {
  ...
  private BuyTwoGetOneDiscount strat;

  @BeforeEach
  void setup() {
    basket = new Basket(Map.of("apple", APPLE));
    strat = new BuyTwoGetOneDiscount(APPLE);
  }
  ...
  private static Stream<Arguments> getDiscountPrice() {
    return Stream.of(
      ...
      Arguments.of(new String[]{"apple", "apple", "apple", "apple"}, BigDecimal.valueOf(0.6)),
      Arguments.of(new String[]{"apple", "apple", "apple", "apple", "apple"}, BigDecimal.valueOf(0.6)),
      Arguments.of(new String[]{"apple", "apple", "apple", "apple", "apple", "apple"}, BigDecimal.valueOf(1.2))
    );
  }
}
